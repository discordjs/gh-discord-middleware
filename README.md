...
| `DISCORD_WEBHOOK_CREATE_DISCORD_BOT`     | The webhook to deliver events to if they are determined to be strictly related to [create-discord-bot](https://github.com/discordjs/discord.js/tree/main/packages/create-discord-bot)                                                                                                |
